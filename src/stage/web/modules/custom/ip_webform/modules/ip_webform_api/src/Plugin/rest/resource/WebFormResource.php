...
/**
 * Provides a resource to get webform data by webforGet webform by id resourcem
 * id.
 *
 * @RestResource(
 *   id = "get_webform_data",
 *   label = @Translation("Get webform by webform id"),
 *   uri_paths = {
 *     "canonical" = "/api/v1/webform/{wid}"
 *   }
 * )
 */
