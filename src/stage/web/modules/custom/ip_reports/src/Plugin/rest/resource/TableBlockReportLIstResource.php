...
/**
 * Provides a resource to get table_block_report list.
 *
 * @RestResource(
 *   id = "get_table_block_report_node_list",
 *   label = @Translation("Get Table Blocks for Report list"),
 *   uri_paths = {
 *     "canonical" = "/api/v1/table_block_report/list"
 *   }
 * )
 */
class TableBlockReportLIstResource extends ResourceBase {
