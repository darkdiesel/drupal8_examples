...
/**
 * Provides a resource to get chart lists
 *
 * @RestResource(
 *   id = "get_easychart_node_list",
 *   label = @Translation("Get chart list"),
 *   uri_paths = {
 *     "canonical" = "/api/v1/easychart/list"
 *   }
 * )
 */
class ChartListResource extends ResourceBase {
